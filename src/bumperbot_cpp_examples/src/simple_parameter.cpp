...
public:
    Simple_Parameter() : Node("SimpleParameter")
    {

        declare_parameter<int>("simple_int_param", 28);
        declare_parameter<std::string>("simple_string_param", "Nader");

        param_callback_handle_ = add_on_set_parameters_callback(std::bind(&Simple_Parameter::ParamChangeCallback, this, _1));
    }
